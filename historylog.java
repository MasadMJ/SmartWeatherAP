...
public class historylog extends AppCompatActivity {
    ...
    Database dbHelper = new Database(historylog.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // callMyDb("info","history");
       // texttranslate.setText("Loading");
        dbHelper.displayDataLog();
        buttonClear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //callMyDb("clear","history");
                dbHelper.deleteData("log");
                texttranslate.setText("");
                Toast.makeText(historylog.this,"Logs Deleted",Toast.LENGTH_SHORT).show();
